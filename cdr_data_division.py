...
def main():
    ...
    # Required columns for call_data 
    ...
    # Dataframe for device_data obtained from call_dataset
    ...
    # Converting the three dataframes to csv format
