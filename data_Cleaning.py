...
# Confirming datetime_divider working
...
# Confirming date_modifier working 
...
# Confirming time_modifier working
...
### Function to replace terminology in the dataset as per requirement
...
### Function to remove unwanted data as per requirement
...
### Function to combine all services in one column-147
...
# Confirming combine_All_Services working
...
### Function to Convert data into a specific format
...
# Confirming call_time_fetcher working
...
### Function to create hourly range column
...
# Confirming hourly_range working
...
### Function to create weekly_range column
...
# Confirming weekly_range working
...
def main():
    ...
    # Confirming the changes in terminology
    ...
    # Confirming the data in column
    print(raw_cdr_data[312].unique())



    # If the 147 column has missing data, then create the data from 312 and 267
    raw_cdr_data[147] = combine_All_Services(raw_cdr_data[147].tolist(),
                                             raw_cdr_data[312].tolist(),
                                             raw_cdr_data[267].tolist())
    
    # Confirming data in column 147
    print(raw_cdr_data[147])



    # Creating new columns of starttime, endtime, duration
    ...
    # creating new columns of hourly_range and weekly_range
